...
public struct _POP_FX_DEVICE
{
    ...
    public byte[] NextIrpDeviceObject;
    [FieldOffset(568)]
    [MarshalAs(UnmanagedType.ByValArray, SizeConst=2)]
    public byte[] NextIrpPowerState;
    [FieldOffset(576)]
    [MarshalAs(UnmanagedType.ByValArray, SizeConst=2)]
    public byte[] NextIrpCallerCompletion;
    [FieldOffset(592)]
    [MarshalAs(UnmanagedType.ByValArray, SizeConst=2)]
    public byte[] NextIrpCallerContext;
    [FieldOffset(608)]
