...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class InvertedFunctionTableKernelMode : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public InvertedFunctionTableKernelMode(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<InvertedFunctionTableKernelMode>();
        }
    }
}