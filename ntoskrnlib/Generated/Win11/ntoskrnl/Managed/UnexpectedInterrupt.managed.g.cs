...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class UnexpectedInterrupt : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public UnexpectedInterrupt(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<UnexpectedInterrupt>();
        }
    }
}