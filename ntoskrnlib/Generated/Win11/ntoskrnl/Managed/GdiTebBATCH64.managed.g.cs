...
{
    [DynamicStructure("ntoskrnl!_GDI_TEB_BATCH64")]
    public sealed class GdiTebBATCH64 : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public GdiTebBATCH64(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<GdiTebBATCH64>();
        }
    }
}