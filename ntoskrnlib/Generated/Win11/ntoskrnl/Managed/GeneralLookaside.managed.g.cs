...
{
    [DynamicStructure("ntoskrnl!_GENERAL_LOOKASIDE")]
    public sealed class GeneralLookaside : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public GeneralLookaside(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<GeneralLookaside>();
        }
    }
}