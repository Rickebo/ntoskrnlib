...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class NtIoringRegBuffersFlags : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public NtIoringRegBuffersFlags(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<NtIoringRegBuffersFlags>();
        }
    }
}