...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class CacheManagerCallbackFunctions : DynamicStructure
    {
        [Offset(0UL)]
        public IntPtr AcquireForLazyWriteEx { get => ReadHere<IntPtr>(nameof(AcquireForLazyWriteEx)); set => WriteHere(nameof(AcquireForLazyWriteEx), value); }
        ...
        public CacheManagerCallbackFunctions(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<CacheManagerCallbackFunctions>();
        }
    }
}