...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class PEB64 : DynamicStructure
    {
        [Offset(0UL)]
        ...
        [Offset(8UL)]
        public ulong Mutant { get => ReadHere<ulong>(nameof(Mutant)); set => WriteHere(nameof(Mutant), value); }

        [Offset(16UL)]
        public ulong ImageBaseAddress { get => ReadHere<ulong>(nameof(ImageBaseAddress)); set => WriteHere(nameof(ImageBaseAddress), value); }

        [Offset(24UL)]
        public ulong Ldr { get => ReadHere<ulong>(nameof(Ldr)); set => WriteHere(nameof(Ldr), value); }

        [Offset(32UL)]
        public ulong ProcessParameters { get => ReadHere<ulong>(nameof(ProcessParameters)); set => WriteHere(nameof(ProcessParameters), value); }

        [Offset(40UL)]
        public ulong SubSystemData { get => ReadHere<ulong>(nameof(SubSystemData)); set => WriteHere(nameof(SubSystemData), value); }

        [Offset(48UL)]
        public ulong ProcessHeap { get => ReadHere<ulong>(nameof(ProcessHeap)); set => WriteHere(nameof(ProcessHeap), value); }

        [Offset(56UL)]
        public ulong FastPebLock { get => ReadHere<ulong>(nameof(FastPebLock)); set => WriteHere(nameof(FastPebLock), value); }

        [Offset(64UL)]
        public ulong AtlThunkSListPtr { get => ReadHere<ulong>(nameof(AtlThunkSListPtr)); set => WriteHere(nameof(AtlThunkSListPtr), value); }

        [Offset(72UL)]
        public ulong IFEOKey { get => ReadHere<ulong>(nameof(IFEOKey)); set => WriteHere(nameof(IFEOKey), value); }
        ...
        [Offset(88UL)]
        public ulong KernelCallbackTable { get => ReadHere<ulong>(nameof(KernelCallbackTable)); set => WriteHere(nameof(KernelCallbackTable), value); }

        [Offset(88UL)]
        public ulong UserSharedInfoPtr { get => ReadHere<ulong>(nameof(UserSharedInfoPtr)); set => WriteHere(nameof(UserSharedInfoPtr), value); }
        ...
        [Offset(104UL)]
        public ulong ApiSetMap { get => ReadHere<ulong>(nameof(ApiSetMap)); set => WriteHere(nameof(ApiSetMap), value); }
        ...
        [Offset(120UL)]
        public ulong TlsBitmap { get => ReadHere<ulong>(nameof(TlsBitmap)); set => WriteHere(nameof(TlsBitmap), value); }
        ...
        [Offset(136UL)]
        public ulong ReadOnlySharedMemoryBase { get => ReadHere<ulong>(nameof(ReadOnlySharedMemoryBase)); set => WriteHere(nameof(ReadOnlySharedMemoryBase), value); }

        [Offset(144UL)]
        public ulong SharedData { get => ReadHere<ulong>(nameof(SharedData)); set => WriteHere(nameof(SharedData), value); }

        [Offset(152UL)]
        public ulong ReadOnlyStaticServerData { get => ReadHere<ulong>(nameof(ReadOnlyStaticServerData)); set => WriteHere(nameof(ReadOnlyStaticServerData), value); }

        [Offset(160UL)]
        public ulong AnsiCodePageData { get => ReadHere<ulong>(nameof(AnsiCodePageData)); set => WriteHere(nameof(AnsiCodePageData), value); }

        [Offset(168UL)]
        public ulong OemCodePageData { get => ReadHere<ulong>(nameof(OemCodePageData)); set => WriteHere(nameof(OemCodePageData), value); }

        [Offset(176UL)]
        public ulong UnicodeCaseTableData { get => ReadHere<ulong>(nameof(UnicodeCaseTableData)); set => WriteHere(nameof(UnicodeCaseTableData), value); }
        ...
        [Offset(240UL)]
        public ulong ProcessHeaps { get => ReadHere<ulong>(nameof(ProcessHeaps)); set => WriteHere(nameof(ProcessHeaps), value); }

        [Offset(248UL)]
        public ulong GdiSharedHandleTable { get => ReadHere<ulong>(nameof(GdiSharedHandleTable)); set => WriteHere(nameof(GdiSharedHandleTable), value); }

        [Offset(256UL)]
        public ulong ProcessStarterHelper { get => ReadHere<ulong>(nameof(ProcessStarterHelper)); set => WriteHere(nameof(ProcessStarterHelper), value); }
        ...
        [Offset(272UL)]
        public ulong LoaderLock { get => ReadHere<ulong>(nameof(LoaderLock)); set => WriteHere(nameof(LoaderLock), value); }
        ...
        [Offset(560UL)]
        public ulong PostProcessInitRoutine { get => ReadHere<ulong>(nameof(PostProcessInitRoutine)); set => WriteHere(nameof(PostProcessInitRoutine), value); }

        [Offset(568UL)]
        public ulong TlsExpansionBitmap { get => ReadHere<ulong>(nameof(TlsExpansionBitmap)); set => WriteHere(nameof(TlsExpansionBitmap), value); }
        ...
        [Offset(736UL)]
        public ulong AppCompatInfo { get => ReadHere<ulong>(nameof(AppCompatInfo)); set => WriteHere(nameof(AppCompatInfo), value); }

        [Offset(744UL)]
        public STRING64 CSDVersion { get => ReadStructure<STRING64>(nameof(CSDVersion)); set => WriteStructure(nameof(CSDVersion), value); }

        [Offset(760UL)]
        public ulong ActivationContextData { get => ReadHere<ulong>(nameof(ActivationContextData)); set => WriteHere(nameof(ActivationContextData), value); }

        [Offset(768UL)]
        public ulong ProcessAssemblyStorageMap { get => ReadHere<ulong>(nameof(ProcessAssemblyStorageMap)); set => WriteHere(nameof(ProcessAssemblyStorageMap), value); }

        [Offset(776UL)]
        public ulong SystemDefaultActivationContextData { get => ReadHere<ulong>(nameof(SystemDefaultActivationContextData)); set => WriteHere(nameof(SystemDefaultActivationContextData), value); }

        [Offset(784UL)]
        public ulong SystemAssemblyStorageMap { get => ReadHere<ulong>(nameof(SystemAssemblyStorageMap)); set => WriteHere(nameof(SystemAssemblyStorageMap), value); }
        ...
        [Offset(816UL)]
        public ulong PatchLoaderData { get => ReadHere<ulong>(nameof(PatchLoaderData)); set => WriteHere(nameof(PatchLoaderData), value); }

        [Offset(824UL)]
        public ulong ChpeV2ProcessInfo { get => ReadHere<ulong>(nameof(ChpeV2ProcessInfo)); set => WriteHere(nameof(ChpeV2ProcessInfo), value); }
        ...
        [Offset(856UL)]
        public ulong WerRegistrationData { get => ReadHere<ulong>(nameof(WerRegistrationData)); set => WriteHere(nameof(WerRegistrationData), value); }

        [Offset(864UL)]
        public ulong WerShipAssertPtr { get => ReadHere<ulong>(nameof(WerShipAssertPtr)); set => WriteHere(nameof(WerShipAssertPtr), value); }

        [Offset(872UL)]
        public ulong EcCodeBitMap { get => ReadHere<ulong>(nameof(EcCodeBitMap)); set => WriteHere(nameof(EcCodeBitMap), value); }

        [Offset(880UL)]
        public ulong pImageHeaderHash { get => ReadHere<ulong>(nameof(pImageHeaderHash)); set => WriteHere(nameof(pImageHeaderHash), value); }
        ...
        [Offset(912UL)]
        public ListENTRY64 TppWorkerpList { get => ReadStructure<ListENTRY64>(nameof(TppWorkerpList)); set => WriteStructure(nameof(TppWorkerpList), value); }
        ...
        [Offset(1952UL)]
        public ulong TelemetryCoverageHeader { get => ReadHere<ulong>(nameof(TelemetryCoverageHeader)); set => WriteHere(nameof(TelemetryCoverageHeader), value); }
        ...
        [Offset(1976UL)]
        public ulong LeapSecondData { get => ReadHere<ulong>(nameof(LeapSecondData)); set => WriteHere(nameof(LeapSecondData), value); }
        ...
        public PEB64(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<PEB64>();
        }
    }
}