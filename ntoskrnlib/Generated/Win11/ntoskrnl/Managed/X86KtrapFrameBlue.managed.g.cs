...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class X86KtrapFrameBlue : DynamicStructure
    {
        [Offset(0UL)]
        ...
        [Offset(12UL)]
        public ushort TempSegCs { get => ReadHere<ushort>(nameof(TempSegCs)); set => WriteHere(nameof(TempSegCs), value); }

        [Offset(14UL)]
        public byte Logging { get => ReadHere<byte>(nameof(Logging)); set => WriteHere(nameof(Logging), value); }

        [Offset(15UL)]
        public byte FrameType { get => ReadHere<byte>(nameof(FrameType)); set => WriteHere(nameof(FrameType), value); }
        ...
        public X86KtrapFrameBlue(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<X86KtrapFrameBlue>();
        }
    }
}