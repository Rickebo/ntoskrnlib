...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class PpcDbgkdControlSet : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public PpcDbgkdControlSet(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<PpcDbgkdControlSet>();
        }
    }
}