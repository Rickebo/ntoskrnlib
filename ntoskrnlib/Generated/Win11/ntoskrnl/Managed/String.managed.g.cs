...
{
    [DynamicStructure("ntoskrnl!_STRING")]
    public sealed class String : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public String(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<String>();
        }
    }
}