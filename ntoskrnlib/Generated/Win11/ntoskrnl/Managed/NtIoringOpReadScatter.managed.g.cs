...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class NtIoringOpReadScatter : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public NtIoringOpReadScatter(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<NtIoringOpReadScatter>();
        }
    }
}