...
{
    [DynamicStructure("ntoskrnl!_PROC_IDLE_STATE_ACCOUNTING")]
    public sealed class ProcIdleStateAccounting : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public ProcIdleStateAccounting(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<ProcIdleStateAccounting>();
        }
    }
}