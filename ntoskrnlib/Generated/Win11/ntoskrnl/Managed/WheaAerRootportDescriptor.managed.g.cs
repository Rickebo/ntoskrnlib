...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class WheaAerRootportDescriptor : DynamicStructure
    {
        [Offset(0UL)]
        ...
        [Offset(14UL)]
        public AerRootportDescriptorFlags Flags { get => ReadStructure<AerRootportDescriptorFlags>(nameof(Flags)); set => WriteStructure(nameof(Flags), value); }
        ...
        [Offset(32UL)]
        public uint RootErrorCommand { get => ReadHere<uint>(nameof(RootErrorCommand)); set => WriteHere(nameof(RootErrorCommand), value); }

        public WheaAerRootportDescriptor(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<WheaAerRootportDescriptor>();
        }
    }
}