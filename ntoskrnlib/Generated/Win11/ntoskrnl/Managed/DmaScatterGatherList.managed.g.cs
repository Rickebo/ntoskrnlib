...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class DmaScatterGatherList : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public DmaScatterGatherList(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<DmaScatterGatherList>();
        }
    }
}