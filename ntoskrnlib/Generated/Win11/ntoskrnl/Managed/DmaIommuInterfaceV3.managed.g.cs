...
namespace ntoskrnlib.Win11.ntoskrnl
{
    ...
    public sealed class DmaIommuInterfaceV3 : DynamicStructure
    {
        [Offset(0UL)]
        ...
        [Offset(176UL)]
        public IntPtr CreatePasidDevice { get => ReadHere<IntPtr>(nameof(CreatePasidDevice)); set => WriteHere(nameof(CreatePasidDevice), value); }

        [Offset(184UL)]
        public IntPtr DeletePasidDevice { get => ReadHere<IntPtr>(nameof(DeletePasidDevice)); set => WriteHere(nameof(DeletePasidDevice), value); }

        [Offset(192UL)]
        public IntPtr AttachPasidDevice { get => ReadHere<IntPtr>(nameof(AttachPasidDevice)); set => WriteHere(nameof(AttachPasidDevice), value); }

        [Offset(200UL)]
        public IntPtr DetachPasidDevice { get => ReadHere<IntPtr>(nameof(DetachPasidDevice)); set => WriteHere(nameof(DetachPasidDevice), value); }

        [Offset(208UL)]
        public IntPtr QueryDeviceInfo { get => ReadHere<IntPtr>(nameof(QueryDeviceInfo)); set => WriteHere(nameof(QueryDeviceInfo), value); }

        public DmaIommuInterfaceV3(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<DmaIommuInterfaceV3>();
        }
    }
}