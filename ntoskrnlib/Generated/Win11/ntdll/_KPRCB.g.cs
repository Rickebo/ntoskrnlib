...
namespace ntoskrnlib.Win11.ntdll
{
    ...
    public partial struct _KPRCB
    {
        ...
        [FieldOffset(14524)]
        public uint DpcNormalProcessingActive;
        [FieldOffset(14524)]
        public uint DpcNormalProcessingRequested;
        [FieldOffset(14524)]
        public uint DpcNormalThreadSignal;
        [FieldOffset(14524)]
        public uint DpcNormalTimerExpiration;
        [FieldOffset(14524)]
        public uint DpcNormalDpcPresent;
        [FieldOffset(14524)]
        public uint DpcNormalLocalInterrupt;
        [FieldOffset(14524)]
        public uint DpcNormalPriorityAntiStarvation;
        [FieldOffset(14524)]
        public uint DpcNormalSwapToDpcDelegate;
        [FieldOffset(14524)]
        public uint DpcNormalSpare;
        [FieldOffset(14524)]
        public uint DpcThreadActive;
        [FieldOffset(14524)]
        public uint DpcThreadRequested;
        [FieldOffset(14524)]
        public uint DpcThreadSpare;
        [FieldOffset(14528)]
        ...
        [FieldOffset(37896)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public IntPtr[] LocalSearchContexts;
        [FieldOffset(37912)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public IntPtr[] SearchContexts;
        [FieldOffset(37928)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public IntPtr[] SearchGenerations;
        [FieldOffset(37944)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
        ...
        [FieldOffset(39680)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public _MACHINE_CHECK_CONTEXT[] McheckContext;
        [FieldOffset(39840)]
        ...
        [FieldOffset(39864)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
        public IntPtr[] HiberSwapShadowStacks;
        [FieldOffset(39904)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
        public IntPtr[] HiberSwapShadowStackBases;
        [FieldOffset(39944)]
        ...
        [FieldOffset(40000)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public _KLOCK_QUEUE_HANDLE[] SelfmapLockHandle;
        [FieldOffset(40096)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        ...
        [FieldOffset(44800)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
        public _KAFFINITY_EX[] CacheProcessorSet;
        [FieldOffset(46120)]
