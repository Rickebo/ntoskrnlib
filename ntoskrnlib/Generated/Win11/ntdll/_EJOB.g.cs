...
namespace ntoskrnlib.Win11.ntdll
{
    ...
    public partial struct _EJOB
    {
        ...
        [FieldOffset(1552)]
        public uint CloseDone;
        [FieldOffset(1552)]
        public uint MultiGroup;
        [FieldOffset(1552)]
        public uint OutstandingNotification;
        [FieldOffset(1552)]
        public uint NotificationInProgress;
        [FieldOffset(1552)]
        public uint UILimits;
        [FieldOffset(1552)]
        public uint CpuRateControlActive;
        [FieldOffset(1552)]
        public uint OwnCpuRateControl;
        [FieldOffset(1552)]
        public uint Terminating;
        [FieldOffset(1552)]
        public uint WorkingSetLock;
        [FieldOffset(1552)]
        public uint JobFrozen;
        [FieldOffset(1552)]
        public uint Background;
        [FieldOffset(1552)]
        public uint WakeNotificationAllocated;
        [FieldOffset(1552)]
        public uint WakeNotificationEnabled;
        [FieldOffset(1552)]
        public uint WakeNotificationPending;
        [FieldOffset(1552)]
        public uint LimitNotificationRequired;
        [FieldOffset(1552)]
        public uint ZeroCountNotificationRequired;
        [FieldOffset(1552)]
        public uint CycleTimeNotificationRequired;
        [FieldOffset(1552)]
        public uint CycleTimeNotificationPending;
        [FieldOffset(1552)]
        public uint TimersVirtualized;
        [FieldOffset(1552)]
        public uint JobSwapped;
        [FieldOffset(1552)]
        public uint ViolationDetected;
        [FieldOffset(1552)]
        public uint EmptyJobNotified;
        [FieldOffset(1552)]
        public uint NoSystemCharge;
        [FieldOffset(1552)]
        public uint DropNoWakeCharges;
        [FieldOffset(1552)]
        public uint NoWakeChargePolicyDecided;
        [FieldOffset(1552)]
        public uint NetRateControlActive;
        [FieldOffset(1552)]
        public uint OwnNetRateControl;
        [FieldOffset(1552)]
        public uint IoRateControlActive;
        [FieldOffset(1552)]
        public uint OwnIoRateControl;
        [FieldOffset(1552)]
        public uint DisallowNewProcesses;
        [FieldOffset(1552)]
        public uint Silo;
        [FieldOffset(1552)]
        public uint ContainerTelemetryIdSet;
        [FieldOffset(1556)]
        public uint JobFlags2;
        [FieldOffset(1556)]
        public uint ParentLocked;
        [FieldOffset(1556)]
        public uint EnableUsermodeSiloThreadImpersonation;
        [FieldOffset(1556)]
        public uint DisallowUsermodeSiloThreadImpersonation;
        [FieldOffset(1556)]
        public uint JobGraphicsFreezeOptimized;
        [FieldOffset(1560)]
