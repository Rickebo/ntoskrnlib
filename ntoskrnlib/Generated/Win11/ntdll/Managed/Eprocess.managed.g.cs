...
{
    [DynamicStructure("ntdll!_EPROCESS")]
    public sealed class Eprocess : DynamicStructure
    {
        ...
        [Offset(1976UL)]
        [Length(4)]
        public DynamicArray SyscallProviderReserved { get => ReadStructure<DynamicArray>(nameof(SyscallProviderReserved)); set => WriteStructure(nameof(SyscallProviderReserved), value); }
