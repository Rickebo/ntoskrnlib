...
{
    [DynamicStructure("ntdll!_HEAP_ENTRY")]
    public sealed class HeapEntry : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public HeapEntry(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<HeapEntry>();
        }
    }
}