...
{
    [DynamicStructure("ntdll!_INTERFACE")]
    public sealed class Interface : DynamicStructure
    {
        [Offset(0UL)]
        ...
        public Interface(IMemorySource memory, MemoryPointer baseAddress) : base(memory, baseAddress)
        {
        }
        ...
        {
            DynamicStructure.Register<Interface>();
        }
    }
}